...
// STM32F411xx DISCOVERY - arduino mega 2560 - logic analyzer 8 channel - logic converter 8 channel 5V <-> 3.3V - USB UART converter
// DS1307 Real-time Clock Module - lcd1602
 ...
 */
#define TIM2_BASEADDR			PERIPH_BASE
#define TIM3_BASEADDR			(PERIPH_BASE + 0x0400U)
#define TIM4_BASEADDR			(PERIPH_BASE + 0x0800U)
#define TIM5_BASEADDR			(PERIPH_BASE + 0x0C00U)
#define RTC_BASEADDR			(PERIPH_BASE + 0x2800U)
#define WWDG_BASEADDR			(PERIPH_BASE + 0x2C00U)
#define IWDG_BASEADDR			(PERIPH_BASE + 0x3000U)
#define I2S2_BASEADDR			(PERIPH_BASE + 0x3400U)
#define SPI2_BASEADDR			(PERIPH_BASE + 0x3800U)
#define SPI3_BASEADDR			(PERIPH_BASE + 0x3C00U)
#define I2S3_BASEADDR			(PERIPH_BASE + 0x4000U)
#define USART2_BASEADDR			(PERIPH_BASE + 0x4400U)
#define I2C1_BASEADDR			(PERIPH_BASE + 0x5400U)
#define I2C2_BASEADDR			(PERIPH_BASE + 0x5800UL)
#define I2C3_BASEADDR			(PERIPH_BASE + 0x5C00U)
#define PWR_BASEADDR			(PERIPH_BASE + 0x7000U)
 ...
 */
typedef struct {
	__vo uint32_t MODER; /*!< GPIO port mode register,      						address ofset: 0x00          >*/
	__vo uint32_t OTYPER; /*!< GPIO port output type register,      				address ofset: 0x04          >*/
	__vo uint32_t OSPEEDR; /*!< GPIO port output speed register,      				address ofset: 0x08          >*/
	__vo uint32_t PUPDR; /*!< GPIO port pull-up/pull-down register ,      		address ofset: 0x0C          >*/
	__vo uint32_t IDR; /*!< GPIO port input data register,      				address ofset: 0x10          >*/
	__vo uint32_t ODR; /*!< GPIO port output data register,      				address ofset: 0x14          >*/
	__vo uint32_t BSRR; /*!< GPIO port bit set/reset register,      			address ofset: 0x18          >*/
	__vo uint32_t LCKR; /*!< GPIO port configuration lock register,     		address ofset: 0x1C          >*/
	__vo uint32_t AFRL[2]; /*!< AFRL[0]:GPIO alternate function low register,      address ofset: 0x20          >*/
/*!< AFRL[1]:GPIO alternate function high register,  	address ofset: 0x20			 >*/
} GPIO_Regdef_t;
...
typedef struct {
	...
	uint32_t RESERVED4; /*!< Reserved, 0x58 0x5C                                                       */
...
typedef struct {
	...
	__vo uint32_t SR; /*!< Give a short description,                    		Address offset: 0x08      	*/
	__vo uint32_t DR; /*!< Give a short description,                    		Address offset: 0x0C      	*/
	__vo uint32_t CRCPR; /*!< Give a short description,                    		Address offset: 0x10      	*/
	__vo uint32_t RXCRCR; /*!< Give a short description,                    	Address offset: 0x14      	*/
	__vo uint32_t TXCRCR; /*!< Give a short description,                    	Address offset: 0x018      	*/
	__vo uint32_t I2SCFGR; /*!< Give a short description,         		        Address offset: 0x1C      	*/
	__vo uint32_t I2SPR; /*!< Give a short description,                  	  	Address offset: 0x20      	*/
} SPI_RegDef_t;
...
/*
 * Clock Disnable Macros for I2Cx peripherals
 */
